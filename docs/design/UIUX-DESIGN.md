...
- **Put the action on the question it answers.** Finding faces belongs on the People heading as a small link, not in a row of buttons of its own — it's how that section gets filled in.
